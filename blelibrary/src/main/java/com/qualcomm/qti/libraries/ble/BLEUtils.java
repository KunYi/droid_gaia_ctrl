...
public class BLEUtils {
     ...
     * {@link com.qualcomm.qti.libraries.ble.BLEService.State#CONNECTED CONNECTED},
     * {@link com.qualcomm.qti.libraries.ble.BLEService.State#CONNECTING CONNECTING},
     * {@link com.qualcomm.qti.libraries.ble.BLEService.State#DISCONNECTING DISCONNECTING} and
     * {@link com.qualcomm.qti.libraries.ble.BLEService.State#DISCONNECTED DISCONNECTED}, this
     * method returns "UNKNOWN" as the label.</p>
     *
     * @param state
     *          The state to get a corresponding label for.
    ...
    public static String getConnectionStateName(@BLEService.State int state) {
        return state == BLEService.State.CONNECTED ? "CONNECTED" :
     ...
     * These status can be:
     * <ul>
     *     <li>{@link com.qualcomm.qti.libraries.ble.ErrorStatus.HCI HCI} or
     *     {@link com.qualcomm.qti.libraries.ble.ErrorStatus.ATT ATT} layers related.</li>
     *     <li>Android {@link com.qualcomm.qti.libraries.ble.ErrorStatus.GattApi GattApi} implementation related as
     ...
     * <ul>
     *     <li>{@link com.qualcomm.qti.libraries.ble.ErrorStatus.HCI#getLabel(int, boolean) HCI.getLabel()} and
     *     {@link com.qualcomm.qti.libraries.ble.ErrorStatus.ATT#getLabel(int, boolean) ATT.getLabel()}</li>
     *     <li>{@link com.qualcomm.qti.libraries.ble.ErrorStatus.GattApi#getLabel(int, boolean) GattApi.getLabel()}</li>
     *     <li>{@link com.qualcomm.qti.libraries.ble.ErrorStatus#getBluetoothGattStatusLabel(int, boolean)
