...
public class BatteryActivity extends ServiceActivity {
     ...
     * alert.</p>
     * <p>If the device is disconnected this method will request the GAIAGATTBLEService to reconnect to the device.</p>
     *
    ...
    private void onReceiveGattMessage(@GAIAGATTBLEService.GattMessage int gattMessage, Object content) {
        if (gattMessage == GAIAGATTBLEService.GattMessage.BATTERY_LEVEL_UPDATE) {
     ...
     *
     * @param services The provided Battery services map as known by the application through the GAIAGATTBLEService.
     */
     ...
     * {@link com.qualcomm.qti.gaiacontrol.models.gatt.GATT.PresentationFormat.Description Description} value.</p>
     *
