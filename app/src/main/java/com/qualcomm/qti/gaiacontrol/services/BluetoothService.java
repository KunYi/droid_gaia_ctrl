...
//    @SuppressLint("ShiftFlags") // values are more readable this way
    @interface Transport {
        ...
        int UNKNOWN = -1;
        /**
         * <p>The Bluetooth Low Energy transport implemented in {@link GAIAGATTBLEService GAIAGATTBLEService}.</p>
         */
        int BLE = 0;
        /**
    ...
    @interface Messages {
         ...
         * <p>This type of {@link android.os.Message Message} also contains:</p>
         * <ul>
         *     <li>The type of GATT message as listed in {@link GAIAGATTBLEService.GattMessage GattMessage}.
         ...
         * <p>This type of {@link android.os.Message Message} also contains:</p>
         * <ul>
         *     <li>The type of upgrade message as listed in {@link GAIAGATTBLEService.UpgradeMessage UpgradeMessage}.
         *     This information is contained in <code>{@link android.os.Message#arg1 msg.arg1}</code>.</li>
    ...
    @interface UpgradeMessage {
         ...
         * <p>This type of {@link android.os.Message Message} also contains:</p>
         * <ul>
         *     <li>A <code>double</code> value corresponding to the percentage of the done upload. This
         *     information is contained in <code>{@link android.os.Message#obj obj}</code>.</li>
         * </ul>
         */
     ...
     * {@link GAIAGATTBLEService.GattMessage#LINK_LOSS_ALERT_LEVEL LINK_LOSS_ALERT_LEVEL}.</p>
     *
     ...
     * <p>The value will be sent asynchronously to the listeners attached to this Service using the
     * {@link Messages#GATT_MESSAGE GATT_MESSAGE} with
     * {@link GAIAGATTBLEService.GattMessage#TX_POWER_LEVEL TX_POWER_LEVEL}.</p>
     *
     * @return True if the request has successfully been added to the queue of requests.
     */
     ...
     * <p>The value will be sent asynchronously to the listeners attached to this Service using the
     * {@link Messages#GATT_MESSAGE GATT_MESSAGE} with
     * {@link GAIAGATTBLEService.GattMessage#BATTERY_LEVEL_UPDATE BATTERY_LEVEL_UPDATE}.
     * </p>
     *
     ...
     * <p>The value will be sent asynchronously to the listeners attached to this Service using the
     * {@link Messages#GATT_MESSAGE GATT_MESSAGE} with
     * {@link GAIAGATTBLEService.GattMessage#BODY_SENSOR_LOCATION BODY_SENSOR_LOCATION}.</p>
     *
     * @return True if the request has successfully been added to the queue of requests.
     */
     ...
     * {@link Messages#GATT_MESSAGE GATT_MESSAGE} with
     * {@link GAIAGATTBLEService.GattMessage#HEART_RATE_MEASUREMENT HEART_RATE_MEASUREMENT}.</p>
     *
     * @return True if the request has successfully been added to the queue of requests.
     */
    ...
    boolean startRssiUpdates(@SuppressWarnings("UnusedParameters") boolean start);

    /**
     * <p>The GAIA Upgrade process is managed from the BluetoothService directly instead of from the activity for
     * all other GAIA activities.</p>
     * <p>In order to process the corresponding GAIA packets, the service needs to know if it is currently
     * processing the upgrade commands.</p>
     *
     * @param enable
     *          True to enable the upgrade mode, false otherwise.
     */
    void enableUpgrade(boolean enable);
}
