...
public class HeartRateActivity extends ServiceActivity {
    ...
    private void onReceiveGattMessage(@GAIAGATTBLEService.GattMessage int gattMessage, Object content) {
        switch (gattMessage) {
            case GAIAGATTBLEService.GattMessage.HEART_RATE_MEASUREMENT:
            ...
            case GAIAGATTBLEService.GattMessage.BODY_SENSOR_LOCATION:
     ...
     * {@link com.qualcomm.qti.gaiacontrol.models.gatt.GattServiceHeartRate.HeartRateMeasurementValues#NO_VALUE NO_VALUE}
     * the default unknown value is displayed:
     * {@link com.qualcomm.qti.gaiacontrol.R.string#heart_rate_no_value heart_rate_no_value}.</p>
     *
     * @param value
