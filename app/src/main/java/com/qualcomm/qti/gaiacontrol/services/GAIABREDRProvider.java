...
/*package*/ class GAIABREDRProvider extends BREDRProvider implements UpgradeGaiaManager.GaiaManagerListener {
     ...
     */
    /*package*/ void enableUpgrade(boolean enable) {
        if (enable && mUpgradeGaiaManager == null) {
     ...
     */
    /*package*/ void enableDebugLogs(boolean enable) {
    ...
    public void onUploadProgress(double percentage) {
        sendMessageToListener(Messages.UPGRADE_MESSAGE,
                BluetoothService.UpgradeMessage.UPGRADE_UPLOAD_PROGRESS, percentage);
    }
