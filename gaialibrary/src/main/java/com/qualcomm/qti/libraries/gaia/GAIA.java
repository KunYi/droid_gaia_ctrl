...
public final class GAIA {
     ...
     *
     * @return the {@link GAIA.Status} corresponding to the value or
     * {@link com.qualcomm.qti.libraries.gaia.GAIA.Status#NOT_STATUS} if neither {@link GAIA.Status} fits the value.
     */
