...
public class GaiaPacketBLE extends GaiaPacket {
     ...
     */
    public static final int PACKET_INFORMATION_LENGTH = LENGTH_COMMAND_ID + LENGTH_VENDOR_ID;
    /**
     * <p>The minimum length of a packet.</p>
     */
    public static final int MIN_PACKET_LENGTH = PACKET_INFORMATION_LENGTH;
    ...
    byte[] buildBytes(int commandId, byte[] payload) throws GaiaException {
        // no check on payload length: with the MTU size the size of a packet over BLE can vary.
